...
if __name__ == '__main__':
    ...
    while True:
        ...
        print("CurrentFieldOfView: ", client.simGetCurrentFieldOfView(camera_name))
        print("DistortionParams: ", client.simGetDistortionParams(camera_name))
        print("FocusAperture: ", client.simGetFocusAperture(camera_name))
